    ...
    <Aboutus>
      ...
      <div className="Ourmission">
        <div className="write">
          <h1>Our Mission</h1>
          <p>
            At West Vent Trust Bank, we're dedicated to empowering individuals,
            families, and businesses to achieve their financial goals through
            innovative banking solutions, personalized service, and unwavering
        ...
        <div className="ourjornrybox">
          <div className="ourbox">
            ...
            <div className="secodnbx">
              <p>The Beginning</p>
              <span>
                West Vent Trust Bank was founded with a simple mission: to
                provide honest, reliable banking services to our local
                community.
              </span>
            </div>
          </div>
